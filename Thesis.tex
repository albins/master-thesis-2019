...
reference types are created. In order to describe the full analysis, we need to
also consider how these relations extend across program execution through
sequencing or branching. Finally, we will also study how provenance variables
come into relation with each other through type unification and assignments.
