...
individuals. \textbf{The only way to find a larger vision is to be somewhere in
  particular} [emphasis mine].}%
{Donna Haraway, \citetitle{haraway}~(\citeyear{haraway})}

{\footnotesize Being easily confused about the reality of the world, one of my
...
\epigraph{\fixme{short quote}}{hello}
%\mainmatter{}
...
($\rho$), this type environment is stateful, in that for example typing a
reference-constructing expression would modify the typing environment to add a
new loan.
