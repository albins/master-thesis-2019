...
Let us return to our example code in Listing~\ref{mir-example-input} and the MIR in
Figure~\ref{fig:mir-example}. Starting at the first block, \fixme{describe the
  facts emitted in various places}. \fixme{maybe insert a Polonius fact graph?}.

The general information flow for the fact generation through Rust can be seen in
Figure~\fixme{a figure}.
