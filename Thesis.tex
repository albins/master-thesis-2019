...
\documentclass[11pt,a4paper,twoside,openany,draft]{report}
...
\begin{sourcecode}
  \captionof{listing}{Calculating transitive moves: a move, initialisation, or
    ...
    the prefix' children. Identical rules for for \InDatalog{path_assigned_at(P, _)} and
