...
\begin{table}[h]
  \begin{tabular}{@{}l l m{5.5cm}}
    ...
    \InDatalog{cfg_edge(P, Q)}\notmine & Fact & A transition in the CFG. \\
    \InDatalog{child(Path2, Path1)} & Fact & \InDatalog{Path1} is a prefix of-, and not equal to \InDatalog{Path2}  \\
...
\subsection{What Is Being Borrowed and Moved?}\label{sec:paths}
