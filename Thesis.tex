...
the current borrow checker. This report describes a partial implementation of an
...
patterns like the one in Listing~\ref{lst:motivating-example}.
...
earlier compiler pass. Additionally, this report analyses real-world Rust code
