...
Polonius is a reformulation of Rust's signature borrow check in Datalog.
  ...
  under analysis seems to have the highest correlation to longer solve-times,
...
\begin{figure}
  ...
  \caption{A graph rendering of the MIR produced from the \InRust{main()}
    ...
    the block. Take special note of the lack of calls to \InRust{drop(_6)}; as
...
\begin{figure}
  ...
  \caption{An overview of how the inputs and intermediate steps of Polonius
    ...
    boldface, and facts in regular font. The historical term ``region'' is used
    here instead of provenance variables to match the convention used in the
    actual code.}
...
compiler-generated), which we used to measure Polonius solve-time performance as
...
\begin{figure}
  ...
  \caption{Scatter plot of solve-times under the naive and optimised algorithms
    ...
    (runtimes below 1~s or above 13~minutes). Y~axis is runtime in seconds.}
