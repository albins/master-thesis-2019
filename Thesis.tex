...
\begin{sourcecode}
  \captionof{listing}{A small (and meaningless) Rust program to illustrate
    MIR~output, featuring branching and a function
    application.}\label{lst:mir-example-input}
\begin{minted}{rust}
fn main() {
    let x = 17;
    let z = if x == 3 {
