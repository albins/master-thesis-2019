...
translated to Polonius input files for a total of \fixme{186GB}~of tab-separated
...
not compile was discarded, as was any repository with more than 4GB~of input
data for any relation, or where fact generation took longer than 15~minutes due
to RAM- and time constraints. After this selection process, \fixme{10 000}
repositories remained for the final study.
